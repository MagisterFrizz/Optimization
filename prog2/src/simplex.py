...
def simplex(C: Matrix, A: Matrix, d: Matrix, Acounter, Ccounter, accuracy=1, log=0):
...
def preprocess_and_simplex():
    ...
    with open("./prog2/input_data.txt", "r") as inputf:
        ...
        simplex(C, A, d, Acounter, Ccounter, log=0)